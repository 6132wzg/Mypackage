...
import h5PhoneSeckillItemComponent from './h5-phone.seckill.item.component'

export default {
  name: 'h5PhoneSeckillCourseComponent',
  bem: {
    b: 'h5-phone-seckill-component'
  },
  components: {
    swiper,
    h5PhoneSeckillItemComponent,
  ...
  data() {
    return {
      ...
      titleBg:
        'https://styd-frontend.oss-cn-shanghai.aliyuncs.com/images/index-group-bg.png'
    }
  },
  methods: {
    imgFilter
