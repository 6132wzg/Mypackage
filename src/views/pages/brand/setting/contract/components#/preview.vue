<template>
  <div
    :class="b()"
    :style="{
      fontSize: info.contract_font_size + 'px',
      'margin-top': info.contract_marget + 'mm'
    }"
  >
      ...
      <a-row>
        ...
        <a-col :span="8" v-if="info.contract_type === CONTRACT_TYPE.PACKAGE">
          <div class="info-item">
            ...
            <span class="info-text">即时生效</span>
          </div>
        </a-col>
        <a-col :span="24">
          <div class="info-item">
    ...
    <footer :class="b('footer')">
      <a-row>
        <a-col :span="12" v-if="info.is_member_signed_name">
          <div class="info-item">
            <label class="info-lable">会员签名：</label>
          </div>
          <div class="info-item" v-if="info.is_signed_date">
            <label class="info-lable">签订日期：</label>
            <!-- <span class="info-text">{{today | dateFilter('YYYY年M月D日') }}</span> -->
          </div>
        </a-col>
        <a-col :span="12" v-if="info.is_brand_signed_name">
          <div class="info-item">
