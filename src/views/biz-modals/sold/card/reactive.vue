...
export default {
  ...
  rxState() {
    return {
      list_num: this.reactiveService.list_num$,
      loading: this.reactiveService.loading$
    }
  },
  props: {
    ids: {
  ...
  mounted() {
    this.reactiveService.getTaskReactiveNum(this.searchQuery).subscribe()
  },
  data() {
