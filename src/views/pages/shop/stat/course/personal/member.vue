      ...
      <header :class="bHeader('header')">
        <div :class="bHeader('button-wapper')">
          <st-button
            ...
            v-if="auth.export"
            v-export-excel="{
              type: 'personal-member/shop/export',
              query: $searchQuery
            }"
          >
            全部导出
      ...
      <main :class="b('mian')">
        ...
        >
          <a
            ...
            slot-scope="item"
            v-modal-link="{
              name: 'shop-stat-personal-reserve-modal',
              props: {
                query: $searchQuery,
                title: '预约明细',
                type: 'shop-personal-member'
              }
            }"
          >
            <st-total-item
...
import ShopStatPersonalReserveModal from '@/views/biz-modals/stat/personal-reserve'
...
export default {
  ...
  modals: {
    ...
    ShopStatPersonalReserveModal
  },
  bem: {
    b: 'page-shop-member-personal-course',
  ...
  methods: {
    ...
    memberChange(data) {
      console.log('member change', data)
    }
  },
  components: {
    MemberSelect,
